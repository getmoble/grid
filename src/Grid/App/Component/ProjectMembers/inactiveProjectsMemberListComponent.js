ko.components.register('inactiveprojectmemberslist', {
    viewModel: function (params) {
        ...
        self.SubscribeDelete = function (data) {
            self.isBusy(true);
            var deleteResult = rapid.dataManager.postData(urls.generic.delete + "projectmember" + "s/" + data.entityId);
    ...
    template: { fromUrl: 'List?type=inactiveprojectmembers' }
});