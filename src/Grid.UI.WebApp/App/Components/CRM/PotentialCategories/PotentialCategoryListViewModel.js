define(["require", "exports", 'knockout', 'interactionService', 'navigationService', 'dataManager'], function (require, exports, ko, interactionService, navigationService, dataManager) {
    var vm = function () {
        ...
        self.loadAll = function () {
            self.isBusy(true);
            var apiUrl = '/Api/PotentialCategories';
        ...
        self.delete = function (row) {
            interactionService.confirm("Are you sure, you want to delete this Potential Category?", function (result) {
                if (result) {
                    var deleteUrl = '/Api/PotentialCategories/Delete/' + row.Id;
        ...
        self.details = function (row) {
            var detailsUrl = "#potentialcategory/" + row.Id;
            navigationService.navigate(detailsUrl);
        }
        self.edit = function (row) {
            var editUrl = "#potentialcategory/edit/" + row.Id;
