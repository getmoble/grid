define(["require", "exports", 'knockout', 'komapping', 'dataManager', 'interactionService', 'navigationService'], function (require, exports, ko, mapping, dataManager, interactionService, navigationService) {
    var vm = function (params) {
        ...
        self.selected = {
            ...
            RecommendedVersion: ko.observable(),
            Status: ko.observable(),
            LicenseType: ko.observable(),
            LicensesAllowed: ko.observable(),
            SoftwareCategoryId: ko.observable()
        }

        self.submitForm = function (formElement) {
            self.isBusy(true);
            var updateUrl = '/Api/Softwares/Update';
        ...
        self.load = function (id) {
            self.isBusy(true);
            var apiUrl = "/Api/Softwares/Get/" + id;
