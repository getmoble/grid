...
namespace Grid.Features.HRMS.ViewModels
{
    public class UserViewModel : ViewModelBase
    {
        ...
        public Features.HRMS.Entities.User ReportingPerson { get; set; }

        public long? ManagerId { get; set; }
        public Features.HRMS.Entities.User Manager { get; set; }
        ...
        public List<Features.HRMS.Entities.User> Reportees { get; set; }
        ...
        public Dictionary<string, int> GroupedAwards
        {
            get
            {
                ...
                return keyvalues.ToDictionary(value => value.Key, value => value.Value);
            }
        }
        ...
        public UserViewModel()
        {
            ...
            Reportees = new List<Features.HRMS.Entities.User>();
            //Tokens = new List<Token>();
            UserAwards = new List<UserAward>();
            //LeaveEntitlementUpdates = new List<LeaveEntitlementUpdate>();
        }

        public UserViewModel(Features.HRMS.Entities.User user) : this()
        {
            Id = user.Id;
